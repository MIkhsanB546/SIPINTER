...
@section('title', 'Tingkat: ' . $tingkat->nama_tingkat)
...
<div class="mb-8">
    ...
    <h1 class="text-3xl font-extrabold text-gray-900">{{ $tingkat->nama_tingkat }}</h1>
    <p class="text-gray-500 mt-1 text-lg">Materi tingkat {{ $tingkat->nama_tingkat }}</p>
</div>
