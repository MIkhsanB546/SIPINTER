...
<head>
    ...
    <style>
        :root { --si-primary: #095890; --si-primary-hover: #0A6AAE; --si-light-bg: #F5F9FC; --si-border: #DDE7EF; --si-text-dark: #1E293B; --si-muted: #64748B; }
        * { scroll-margin-top: 80px; }
        body { font-family: 'Inter', 'Source Sans 3', sans-serif; background: #f4f6f9; color: #1E293B; }
        ...
        .color-card { border-radius: 12px; overflow: hidden; border: 1px solid var(--si-border); background: #fff; }
        .color-swatch { height: 70px; }
        .color-body { padding: 10px 14px; }
        .color-body code { font-size: .75rem; }
        .sg-preview-wrap { border: 1px solid var(--si-border); border-radius: 12px; overflow: hidden; background: #fff; }
...
<header class="sg-header">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <p class="mt-1">Frontend siswa menggunakan TailwindCSS dengan gaya pembelajaran interaktif yang terinspirasi oleh Duolingo dan Codecademy.</p>
...
<main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
    ...
    <section class="sg-section" id="warna">
        ...
        <p class="text-gray-500 mb-4">Warna utama frontend siswa. Didefinisikan sebagai variabel CSS di <code>:root</code> pada <code>layouts/student.blade.php</code>.</p>
        @php
            $colors = [
    ...
    <section class="sg-section" id="tipografi">
        ...
        <p class="text-gray-500 mb-4">Font utama: <strong>Inter</strong> via Tailwind. Semua utility kelas Tailwind yang digunakan di frontend siswa.</p>
    ...
    <section class="sg-section" id="tombol">
        ...
        <div class="sg-preview-wrap mb-4">
            <div class="sg-preview-body flex flex-wrap items-center gap-3">
                <button class="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-semibold text-white rounded-xl transition duration-150 hover:brightness-110" style="background-color: #095890;">
                    <i class="bi bi-check-lg"></i> Simpan Perubahan
                </button>
                <button class="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-semibold text-white rounded-xl transition duration-150 hover:brightness-110" style="background-color: #095890;">
                    <i class="bi bi-arrow-right"></i> Selanjutnya
                </button>
                <div class="sg-code mt-2 w-full"><code>&lt;button class="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-semibold text-white rounded-xl" style="background-color: #095890;"&gt;Simpan Perubahan&lt;/button&gt;</code></div>
            </div>
        </div>
        ...
        <div class="sg-preview-wrap mb-4">
            <div class="sg-preview-body flex flex-wrap items-center gap-3">
                <button class="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-semibold rounded-xl transition duration-150" style="background-color: #F1F5F9; color: #64748B; border: 1px solid #DDE7EF;">
                    <i class="bi bi-arrow-counterclockwise"></i> Reset
                </button>
                <button class="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-semibold rounded-xl transition duration-150" style="background-color: #F1F5F9; color: #64748B; border: 1px solid #DDE7EF;">
                    <i class="bi bi-x-lg"></i> Batal
                </button>
                <div class="sg-code mt-2 w-full"><code>&lt;button class="inline-flex items-center gap-2 px-6 py-2.5 text-sm font-semibold rounded-xl" style="background-color: #F1F5F9; color: #64748B; border: 1px solid #DDE7EF;"&gt;Batal&lt;/button&gt;</code></div>
            </div>
        </div>
        ...
        <div class="sg-preview-wrap">
            <div class="sg-preview-body flex flex-wrap items-center gap-3">
                ...
                <div class="sg-code mt-2 w-full"><code>&lt;a href="#" class="inline-flex items-center justify-center px-5 py-2.5 bg-indigo-50 text-indigo-700 rounded-xl text-sm font-semibold hover:bg-indigo-100 transition-colors"&gt;Kerjakan Quiz&lt;/a&gt;</code></div>
            </div>
        </div>
    </section>
    ...
    <section class="sg-section" id="input">
        ...
        <div class="sg-preview-wrap">
            <div class="sg-preview-body space-y-4 max-w-lg">
                ...
                <div class="sg-code"><code>&lt;input type="text" class="w-full px-4 py-2.5 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" style="border-color: #DDE7EF;"&gt;</code></div>
            </div>
        </div>
    </section>
    ...
    <section class="sg-section" id="kartu">
        ...
        <div class="sg-preview-wrap mb-4">
            <div class="sg-preview-body">
                ...
                <div class="sg-code mt-4"><code>&lt;div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5"&gt;...&lt;/div&gt;</code></div>
            </div>
        </div>
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4" style="max-width: 700px;">
                    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                        ...
                        <div class="p-5">
                            ...
                            <p class="text-xs text-gray-500 mb-1"><i class="bi bi-person me-1"></i>Budi Santoso</p>
                            <p class="text-xs text-gray-500 mb-3"><i class="bi bi-bar-chart me-1"></i>SD</p>
                            <a href="#" class="inline-flex items-center justify-center w-full px-4 py-2.5 bg-indigo-600 text-white rounded-xl text-sm font-semibold hover:bg-indigo-700 transition-colors shadow-sm">Pelajari</a>
                        </div>
                    </div>
                </div>
                <div class="sg-code mt-4"><code>&lt;div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden"&gt;...&lt;/div&gt;</code></div>
            </div>
        </div>
    </section>
        ...
        <div class="sg-preview-wrap">
            <div class="sg-preview-body space-y-4">
                <div class="flex flex-wrap gap-2">
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700">Progress</span>
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-emerald-50 text-emerald-700">Achievement</span>
                ...
                <div>
                    ...
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-gray-100 text-gray-600">Siswa</span>
                </div>
                <div class="sg-code"><code>&lt;span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold bg-indigo-50 text-indigo-700"&gt;Progress&lt;/span&gt;</code></div>
            </div>
        </div>
    </section>
            ...
            <div class="sg-preview-body flex flex-wrap items-center gap-4">
                <div class="flex flex-col items-center gap-1">
                    <img src="https://ui-avatars.com/api/?name=John+Doe&background=095890&color=fff&size=96"
                         class="w-12 h-12 rounded-full border object-cover" style="border-color: #DDE7EF;" alt="Avatar">
                ...
                <div class="flex flex-col items-center gap-1">
                    <div class="w-12 h-12 rounded-full flex items-center justify-center" style="background-color: #E8F0F6;">
                        <i class="bi bi-person-circle text-2xl" style="color: #095890;"></i>
                    </div>
                    <span class="text-xs text-gray-500">Fallback (no avatar)</span>
                </div>
                <div class="sg-code w-full mt-2"><code>@if(auth()->user()->avatar) &lt;img src="..." class="w-12 h-12 rounded-full border object-cover"&gt; @else &lt;i class="bi bi-person-circle text-2xl"&gt; @endif</code></div>
            </div>
        </div>
    </section>
    ...
    <section class="sg-section" id="navbar">
        ...
        <p class="text-gray-500 mb-4">Navbar siswa menggunakan TailwindCSS + AlpineJS. Responsif untuk desktop dan mobile.</p>
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="flex items-center justify-between h-16">
                            ...
                            <div class="hidden lg:flex items-center gap-1 absolute left-1/2 -translate-x-1/2">
                                ...
                                <span class="px-3 py-2 rounded-lg text-sm font-medium text-gray-700"><i class="bi bi-book me-1"></i>Materi Saya</span>
                                <span class="px-3 py-2 rounded-lg text-sm font-medium text-gray-700"><i class="bi bi-pencil-square me-1"></i>Quiz Saya</span>
                                <span class="px-3 py-2 rounded-lg text-sm font-medium text-gray-700"><i class="bi bi-clock-history me-1"></i>Riwayat Quiz</span>
                            </div>
                ...
                <nav class="bg-white" style="border-bottom: 1px solid #DDE7EF;">
                    <div class="px-4">
                        <div class="flex items-center justify-between h-16">
                            <a class="flex items-center gap-2 shrink-0">
                                <img src="{{ asset('images/sipinter-logo.png') }}" alt="SIPINTER" class="h-10 w-auto">
                                <span class="font-bold text-base leading-tight" style="color: #095890;">SIPINTER</span>
                            </a>
                        ...
                        <div class="border-t py-3 space-y-1" style="border-color: #DDE7EF;">
                            <span class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium nav-link-active"><i class="bi bi-grid-fill"></i>Dashboard</span>
                            <span class="flex items-center gap-3 px-3 py.5 rounded-lg text-sm font-medium text-gray-700"><i class="bi bi-book"></i>Materi Saya</span>
                            <span class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700"><i class="bi bi-pencil-square"></i>Quiz Saya</span>
                            <span class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700"><i class="bi bi-clock-history"></i>Riwayat Quiz</span>
                            <hr style="border-color: #DDE7EF;">
                            <div class="flex items-center gap-3 px-3 py-2.5">
                                <img src="https://ui-avatars.com/api/?name=John+Doe&background=095890&color=fff&size=64"
                                     class="w-8 h-8 rounded-full border object-cover" style="border-color: #DDE7EF;" alt="Avatar">
                                <span class="text-sm font-medium text-gray-900">John Doe</span>
                            </div>
                            <span class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700"><i class="bi bi-person" style="color: #095890;"></i>Profil</span>
                            <span class="flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium text-gray-700"><i class="bi bi-box-arrow-right" style="color: #dc2626;"></i>Keluar</span>
                        </div>
                    </div>
                </nav>
            </div>
    ...
    <section class="sg-section" id="profile">
        ...
        <p class="text-gray-500 mb-4">Halaman profil siswa dengan layout dua kolom. Desktop: grid 3 kolom (kiri 1, kanan 2). Mobile: vertikal.</p>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="lg:col-span-1">
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 flex flex-col items-center">
                            <div class="mb-4">
                                <div class="w-28 h-28 rounded-full flex items-center justify-center" style="background-color: #E8F0F6;">
                            ...
                            <p class="text-sm text-center mb-3" style="color: #64748B;"><i class="bi bi-envelope me-1"></i>john@example.com</p>
                            ...
                            <div class="w-full">
                                ...
                                <div class="flex justify-center mb-2">
                                    <img src="https://chart.googleapis.com/chart?chs=150x150&cht=qr&chl=sipinter-qr-demo&choe=UTF-8"
                                         class="w-28 h-28" style="border-radius: 8px; border: 1px solid #DDE7EF;" alt="QR">
                                </div>
                                <span class="flex items-center justify-center gap-1 w-full px-3 py-1.5 text-xs font-medium rounded-full" style="border: 1px solid #DDE7EF; color: #64748B;">
                    ...
                    <div class="lg:col-span-2">
                        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                            ...
                            <div class="space-y-4">
                                <div>
                                    <label class="block text-sm font-semibold mb-1.5" style="color: #1E293B;"><i class="bi bi-person me-1" style="color: #095890;"></i> Nama</label>
                                    <input type="text" value="John Doe" class="w-full px-4 py-2.5 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" style="border-color: #DDE7EF;">
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold mb-1.5" style="color: #1E293B;"><i class="bi bi-envelope me-1" style="color: #095890;"></i> Email</label>
                                    <input type="email" value="john@example.com" class="w-full px-4 py-2.5 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" style="border-color: #DDE7EF;">
                                </div>
                                <hr style="border-color: #DDE7EF;">
                                <div>
                                    <label class="block text-sm font-semibold mb-1.5" style="color: #1E293B;"><i class="bi bi-lock me-1" style="color: #095890;"></i> Password Baru</label>
                                    <input type="password" placeholder="Minimal 8 karakter" class="w-full px-4 py-2.5 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" style="border-color: #DDE7EF;">
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold mb-1.5" style="color: #1E293B;"><i class="bi bi-lock-fill me-1" style="color: #095890;"></i> Konfirmasi Password</label>
                                    <input type="password" placeholder="Ulangi password baru" class="w-full px-4 py-2.5 rounded-xl border text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent" style="border-color: #DDE7EF;">
                                </div>
